public class JvmComprehension {
    ...
    public static void main(String[] args) {
        ...
        Integer ii = 2;                 // 3 3 В Куче создается объект Integer со значением 2,
        ...
        System.out.println("finished"); // 7 7 В Stack'е создается фрейм println,
    ...
    private static void printAll(Object o, int i, Integer ii) {
        Integer uselessVar = 700;                   // 5 5 В Куче создается объект Integer со значением 700,
        // а во фрейме printAll появляется переменная uselessVar со ссылкой на этот объект.
        System.out.println(o.toString() + i + ii);  // 6 6 В Stack'е создается фрейм println,
